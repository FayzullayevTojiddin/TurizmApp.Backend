<x-layouts.app title="Bosh sahifa">
    ...
    <section class="relative bg-gray-900 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-36">
            <div class="max-w-xl">
                <p class="text-blue-400 font-semibold text-sm tracking-wide uppercase mb-4">Ishonchli turizm platformasi</p>
                <h1 class="text-4xl lg:text-5xl font-extrabold text-white leading-tight mb-6">
                    Dunyoni biz bilan kashf eting
                </h1>
                <p class="text-gray-300 text-lg leading-relaxed mb-8">
                    Tayyor tur paketlardan tanlang yoki o'zingizga mos shaxsiy sayohat rejasini yarating.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                @foreach([
                    ...
                    ['icon' => 'map-pin', 'value' => '50+', 'label' => 'Yo\'nalishlar'],
                    ['icon' => 'briefcase', 'value' => '100+', 'label' => 'Tur paketlar'],
        ...
        <section class="py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-end justify-between mb-8">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Tavsiya etilgan turlar</h2>
                        <p class="text-gray-500 text-sm mt-1">Eng mashhur va sevimli tur paketlar</p>
                    </div>
                    <a href="{{ route('tours.index') }}" class="hidden sm:inline-flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-700 transition">
                        Hammasini ko'rish <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </a>
                </div>
    ...
    @if($latestTours->count())
        <section class="py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-end justify-between mb-8">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900">Yangi turlar</h2>
                        <p class="text-gray-500 text-sm mt-1">Eng so'nggi qo'shilgan turlar</p>
                    </div>
                    <a href="{{ route('tours.index') }}" class="hidden sm:inline-flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-700 transition">
                        Hammasini ko'rish <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </a>
    ...
    <section class="bg-gray-900 text-white py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h2 class="text-3xl font-bold mb-4">O'zingizga mos tur topa olmadingizmi?</h2>
            <p class="text-gray-400 mb-8 max-w-lg mx-auto">
                Yo'nalish, mehmonxona va faoliyatlarni tanlab, shaxsiy tur yarating. Biz sizga eng yaxshi narxni taklif etamiz.
            </p>
            @auth
                <a href="{{ route('my-tours.create') }}"
