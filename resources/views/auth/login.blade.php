    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-sm mx-auto px-4">
            <div class="text-center mb-8">
                ...
                <h1 class="text-xl font-bold text-gray-900">{{ __('messages.login_title') }}</h1>
                <p class="text-sm text-gray-500 mt-1">{{ __('messages.login_desc') }}</p>
            </div>
            ...
            <p class="text-center text-sm text-gray-500 mt-5">
                {{ __('messages.no_account') }} <a href="{{ route('register') }}" class="text-blue-600 hover:underline font-medium">{{ __('messages.register_link') }}</a>
            </p>
        </div>
    </section>
</x-layouts.app>