<x-layouts.app title="Ro'yxatdan o'tish">
    <section class="py-20 bg-gray-50">
        <div class="max-w-sm mx-auto px-4">
            <div class="text-center mb-8">
                ...
                <h1 class="text-xl font-bold text-gray-900">Ro'yxatdan o'tish</h1>
                <p class="text-sm text-gray-500 mt-1">Yangi hisob yarating</p>
            </div>
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-1.5">Parolni tasdiqlang</label>
            ...
            <p class="text-center text-sm text-gray-500 mt-5">
                Hisobingiz bormi? <a href="{{ route('login') }}" class="text-blue-600 hover:underline font-medium">Tizimga kiring</a>
            </p>
        </div>
    </section>
</x-layouts.app>